package createAndSendStandardDemoTest;
...
public class CreateAndSendStandardDemoTest extends BaseTest {
    private String demoNameStd = "SS AB STD 0606 AUTOMATED #1 Helix";
    ...
    private String orgName = "SpiralScout_auto";
    private String recEmail = "barkevichanna@gmail.com";
    private String firstRecName = "FRec1Auto";
    private String lastRecName = "LRec1Auto";
    private String titleRec = "Rec_QA1_auto";

    @Test

    public void createAndSendStandardDemoTest () {
